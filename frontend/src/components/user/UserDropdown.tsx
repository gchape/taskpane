    ...
    return (
        <div
            ...
            <div className="px-4 py-3 border-b border-white/10 bg-lime-400/5">
                <p className="text-[13px] font-bold text-zinc-100 tracking-tight">{USER.name}</p>
                <p className="text-[11px] text-zinc-500 mt-0.5 tracking-wide font-mono">{USER.email}</p>
            </div>
