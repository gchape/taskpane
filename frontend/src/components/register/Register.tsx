...
const RegisterLeftPanel = () => (
  <div className="relative flex flex-col justify-center w-full lg:w-1/2 lg:min-w-105 px-8 sm:px-16 py-16 bg-[#09090b] overflow-y-hidden overflow-x-hidden">
    <LeftPanelBackground />

    <div className="relative z-10 max-w-sm w-full mx-auto lg:mx-0">
      <NavLink to="/" className="flex items-center gap-2 my-8 no-underline">
        <span
